...
/**
 * Port for cascading user-deletion side-effects in the reviews bounded
 * context (deleting reviews authored by / about the deleted user, per
 * the PDPA retention policy in docs/policies/pdpa-retention-tri30.md).
 *
