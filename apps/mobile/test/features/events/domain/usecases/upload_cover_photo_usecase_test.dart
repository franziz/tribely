...
void main() {
  ...
  group('UploadCoverPhotoUseCase', () {
    test('delegates to repository and returns storageKey on success', () async {
      when(() => mockRepository.uploadCoverPhoto(tBytes))
    ...
    test('returns ValidationFailure when repository returns size cap failure',
        () async {
    ...
    test('returns NetworkFailure when repository surfaces network error',
        () async {
    ...
    test('returns ServerFailure when presign API returns server error',
        () async {
