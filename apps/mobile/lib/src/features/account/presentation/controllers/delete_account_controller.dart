...
class DeleteAccountController extends Notifier<DeleteAccountState> {
  ...
  ///
  /// No-op if the typed-confirmation gate ([state.isTokenValid]) is false
  /// (guards against programmatic calls when the CTA should be disabled).
  /// Wraps the API call, handles failure classification, and on success
  /// attempts a best-effort sign-out before emitting [DeleteAccountSuccess].
